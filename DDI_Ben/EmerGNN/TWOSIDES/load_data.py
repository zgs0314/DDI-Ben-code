...
class DataLoader:
    def __init__(self, params, saved_relation2id=None):
        ...
        kg_paths = {
            'train': os.path.join(self.task_dir, 'data/{}_KG.txt'.format('train')),
            'valid': os.path.join(self.task_dir, 'data/{}_KG.txt'.format('valid')),
            'test':  os.path.join(self.task_dir, 'data/{}_KG.txt'.format('test'))
        }
